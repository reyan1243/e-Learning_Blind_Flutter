...
double rate = 0.5;
List<String> _ttsMessages = ['Welcome to E-Learning Blind App', "Student Log In", "Student Signup", "Select Your Choice"];
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          InkWell(
                            child: _isListening ?  Icon(Icons.mic) : Icon(Icons.mic_off_outlined),
                            onTap: () {
                              _listen();
